...
const prompt = PromptTemplate.fromTemplate(
  ...
  - 渡す情報は日程、出発地（空港、新幹線駅など）、目的地（空港、新幹線駅など）、希望する観光内容、コンセプト
  - 上記の情報を用いて、旅行プランを作成してください。出発地、最終目的地、経由地は、緯度経度変換させるので、住所を取得してください。もし、住所が不明な場合は、場所の正式名称を返却してください。「現在地」という文字列は使用しないでください。
