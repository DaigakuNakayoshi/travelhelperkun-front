...
const prompt = PromptTemplate.fromTemplate(
  ...
  - 各項目を表示する際は、以下のフォーマットに従ってください。
    - |出発時刻|到着時刻|内容|場所|URL|
    - 出発時刻と到着時刻は、24時間表記で、HH:MM形式で記載すること
    - 内容は、観光地や食事の内容を記載すること
    - 場所は、観光地や食事の場所を記載すること
    - URLは、観光地や食事の場所のURLを記載すること
    - 旅行プランのタイトルは、旅行のテーマや目的地を反映したものにしてください。
    - 旅行プランの説明は、旅行の目的や特徴を簡潔にまとめたものにしてください。
    - 旅行プランのステップは、日ごとに分けて、各日の行動を時系列で記載してください。
    - 旅行費用は、交通費、宿泊費、食費、アクティビティ費用、その他の費用を含めてください。
    - 旅行費用は、総額と一人当たりの費用を記載してください。 
